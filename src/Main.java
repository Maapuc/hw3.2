public class Main {
    public static void main(String[] args) {
        ...
        short trees = 31657;
        System.out.println("в лесу " + trees + " деревьев ");
        ...
        byte c = 30;
        short paper = 480;
        short abc = (short) (a + b + c);
        short paperAbc = (short) (paper / abc);
        System.out.println("на каждого ученика рассчитано " + paperAbc + " листов бумаги ");

        byte twoMinutes = 16;
        short twentyMinutes = (short) (twoMinutes / 2 * 20 );
        ...
        System.out.println("Маша теперь получает " + mashaRich + " рублей. Годовой доход вырос на " + mashaUp + " рублей ");
        System.out.println("Маша теперь получает " + denisRich + " рублей. Годовой доход вырос на " + denisUp + " рублей ");
        System.out.println("Маша теперь получает " + kristinaRich + " рублей. Годовой доход вырос на " + kristinaUp + " рублей ");
